 ...
 */
@Component(value = "EncryptionKeyDeltaAddPolicyUpdate")
public class EncryptionKeyDeltaAddPolicyUpdate extends BasePolicyUpdate {
    ...
    protected EventBusAddress getEventBusAddress() {
        return EventBusAddress.ENCRYPTION_KEY_DATA_PAYLOAD_DELTA_UPDATE_PROCESS;
    }
}